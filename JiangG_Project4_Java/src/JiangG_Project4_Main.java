    ...
    private static class Trees {
        ...
        private static void print23Tree(treeNode root, PrintWriter treeFile) {
            ...
            while (!q.isEmpty()) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (node.father != null) {
                        ...
                        if (node.father.father != null) {
                            treeFile.print(" Tnode.father.father");
                        } else if (node.father.child1 == node) {
                            treeFile.print(" Tnode.father1");
                        } else if (node.father.child2 == node) {
                            treeFile.print(" Tnode.father2");
                        } else if (node.father.child3 == node) {
                            treeFile.print(" Tnode.father3");
                        }
                    } else {
                        treeFile.print("(" + node.key1 + "," + node.key2 + ")");
                    }
                ...
                treeFile.println(); // 输出换行符表示当前层处理完毕
            }
        }
